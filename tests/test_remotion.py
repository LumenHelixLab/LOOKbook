...
def project_with_scenes(tmp_path: Path) -> Path:
    ...
    shot_graph = {
        ...
        "source_file": "test.png", "total_shots": 2, "total_duration_seconds": 9.0, "fps": 24,
        "shots": [
            {
                "shot_index": 0, "scene_index": 0, "type": "establishing",
                "duration_seconds": 4.0, "start_time": 0.0, "end_time": 4.0,
                "panels": [0, 1], "panel_count": 2, "camera": "pan right",
                "transition_in": "fade in", "dialogue": [], "narration": ["The scene opens."],
                "characters": [], "motion_directive": "Slow pan across the scene.",
            },
            {
                "shot_index": 1, "scene_index": 0, "type": "dialogue",
                "duration_seconds": 5.0, "start_time": 4.0, "end_time": 9.0,
                "panels": [2], "panel_count": 1, "camera": "zoom in",
                "transition_in": "cut", "dialogue": ['"Hello."'], "narration": [],
                "characters": ["char_000"], "motion_directive": "Focus on character.",
            },
        ],
    }
